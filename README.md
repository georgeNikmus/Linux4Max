The Linux4Max library brings a selection of linux audio plugins (mainly focused on filters, dynamic processing and physical modeling) into the Max/MSP environment.
