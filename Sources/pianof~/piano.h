...
double getValueDryTapAmpT60(double index) {
	return getValue(index, &DryTapAmpT60_points[0], 16);
}

double getValueSustainPedalLevel(double index) {
	return getValue(index, &sustainPedalLevel_points[0], 13);
}

double getValueLoudPole(double index) {
	return getValue(index, &loudPole_points[0], 19);
}

double getValuePoleValue(double index) {
	return getValue(index, &softPole_points[0], 16);
}

double getValueLoudGain(double index) {
	return getValue(index, &loudGain_points[0], 16);
}

double getValueSoftGain(double index) {
	return getValue(index, &softGain_points[0], 15);
}

double getValueDCBa1(double index) {
	return getValue(index, &DCBa1_points[0], 18);
}

double getValuer1_1db(double index) {
	return getValue(index, &r1_1db_points[0], 3);
}

double getValuer1_2db(double index) {
	return getValue(index, &r1_2db_points[0], 4);
}

double getValuer2db(double index) {
	return getValue(index, &r2db_points[0], 2);
}

double getValuer3db(double index) {
	return getValue(index, &r3db_points[0], 2);
}

double getValueSecondStageAmpRatio(double index) {
	return getValue(index, &secondStageAmpRatio_points[0], 6);
}

double getValueSecondPartialFactor(double index) {
	return getValue(index, &secondPartialFactor_points[0], 2);
}

double getValueThirdPartialFactor(double index) {
	return getValue(index, &thirdPartialFactor_points[0], 2);
}

double getValueBq4_gEarBalled(double index) {
	return getValue(index, &bq4_gEarBalled_points[0], 6);
}

double getValueStrikePosition(double index) {
	return getValue(index, &strikePosition_points[0], 12);
}

double getValueEQBandWidthFactor(double index) {
	return getValue(index, &EQBandwidthFactor_points[0], 13);
}

double getValueEQGain(double index) {
	return getValue(index, &EQGain_points[0], 14);
}

double getValueDetuningHz(double index) {
	return getValue(index, &detuningHz_points[0], 18);
}

double getValueSingleStringDecayRate(double index) {
	return getValue(index, &singleStringDecayRate_points[0], 17);
}

double getValueSingleStringZero(double index) {
	return getValue(index, &singleStringZero_points[0], 17);
}

double getValueSingleStringPole(double index) {
	return getValue(index, &singleStringPole_points[0], 17);
}

double getValueStiffnessCoefficient(double index) {
	return getValue(index, &stiffnessCoefficient_points[0], 10);
}

double getValueReleaseLoopGain(double index) {
	return getValue(index, &releaseLoopGain_points[0], 10);
}
...
double getValueLoopFilterb0(double index) {
	return getValue(index, &loopFilterb0_points[0], 18);
}
...
double getValueLoopFilterb1(double index) {
	return getValue(index, &loopFilterb1_points[0], 18);
}
...
double getValueLoopFilterb2(double index) {
	return getValue(index, &loopFilterb2_points[0], 18);
}
...
double getValueLoopFiltera1(double index) {
	return getValue(index, &loopFiltera1_points[0], 18);
}
...
double getValueLoopFiltera2(double index) {
	return getValue(index, &loopFiltera2_points[0], 18);
}
