...
/*
static inline int pun_double_to_int(double x) {
	union { double d; uint64_t i; } dvx = { x };
	return dvx.i;
}

static inline double pun_int_to_double(int x) {
	union { uint64_t i; double d; } dmx = { (uint64_t)x };
		return dmx.d;
}
*/
